...
===============================================
Script Purpose:
	This stored procedure loads data into the 'bronze' schema from external schema files.
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT'>> Truncatring Table: bronze.crm_cust_info';
		...
		print '>>---------------'
		PRINT'>> Truncatring Table: bronze.crm_prd_info';
		...
		PRINT'>> Truncatring Table: bronze.crm_sales_details';
		...
		SET @start_time = GETDATE();
		PRINT'>> Truncatring Table: bronze.erp_cust_az12';
		...
		SET @start_time = GETDATE();
		PRINT'>> Truncatring Table: bronze.erp_loc_a101';
		...
		SET @start_time = GETDATE();
		PRINT'>> Truncatring Table: bronze.erp_px_cat_g1v2';
		...
		PRINT'	- Total Load Duriation: ' +	CAST(DATEDIFF(second,@batch_start_time,@batch_end_time) AS NVARCHAR) + ' seconds';
		PRINT'======================================'
